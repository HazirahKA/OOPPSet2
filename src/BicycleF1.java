...
public class BicycleF1 extends JFrame implements ActionListener{

    JMenu fileMenu,bikeMenu;
    Bicycle [] bikes; // an array of bikes   NEW
    int count; // number of valid bikes in the array  NEW

    // driver 
    public static void main( String[] args ) {
        BicycleF1 frame = new BicycleF1();
